...
// PURPOSE: Display products with working search
// ============================================================
...
try {
    ...
    $pdo = getDbConnection();
    // ============================================
    // FIX: Build query based on search
    // ============================================  
    $sql = "
        SELECT 
            p.*, 
    ...
    $countSql = str_replace(
        "SELECT p.*, c.name as category_name, s.shop_name, s.shop_slug",
    ...
    // ============================================
    if (!empty($searchQuery)) {
        error_log("Search: '$searchQuery' - Found: " . count($products) . " products");
    }
...
<section class="products-page">
    <div class="container">
        ...
        <div class="page-header">
            <h1><?php echo !empty($searchQuery) ? 'Search Results' : 'Our Products'; ?></h1>
...
function applyFilters() {
    ...
    const search = '<?php echo !empty($searchQuery) ? addslashes($searchQuery) : ''; ?>';
...
// ============================================
// FIX: Enter key triggers search from header
// ============================================
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Search on Enter key from header
    if (searchInput) {
    ...
    console.log('🔍 Search query: <?php echo !empty($searchQuery) ? htmlspecialchars($searchQuery) : 'None'; ?>');
    console.log('📦 Products found: <?php echo count($products); ?>');
});
...
function showNotification(message, type) {
    ...
    notification.style.cssText = `
        ...
        border-left: 4px solid ${type === 'error' ? '#e74c3c' : type === 'warning' ? '#f39c12' : '#27ae60'};
    `;
